...
process create_genbank_submission_files {
  ...
  python ${PSGA_ROOT_PATH}/scripts/genbank/generate_genbank_files.py \
...
process submit_genbank_files {
  ...
  python ${PSGA_ROOT_PATH}/scripts/genbank/submit_genbank_files.py \
...
process mark_samples_as_submitted_to_genbank{
  ...
  """
  python ${PSGA_ROOT_PATH}/scripts/genbank/mark_submitted_genbank_samples.py \
    --analysis-run-name "${ch_analysis_run_name}" \
