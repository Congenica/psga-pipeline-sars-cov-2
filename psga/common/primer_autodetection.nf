...
process primer_autodetection {
  ...
  primer_index="/primer_schemes/!{pathogen}_primer_fasta_index.txt"

  python ${PSGA_ROOT_PATH}/scripts/common/primer_autodetection.py --primer-index /primer_schemes/!{pathogen}_primer_fasta_index.csv --sample-fastq "${file_1}" --sample-id "${sample_id}" --primer-input !{params.kit}
  '''
}
