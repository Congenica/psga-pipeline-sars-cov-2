process pipeline_start {
  ...
  echo "nextflow run ${PSGA_ROOT_PATH}/psga --run ${params.run} --sequencing_technology ${params.sequencing_technology} --metadata ${params.metadata} --kit ${params.kit} -resume \\\$1" >> ${session_id_file}
  """
}
