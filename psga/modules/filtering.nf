...
workflow filter_samples_with_one_file {
    take:
    ...
    main:
        ...
        ch_metadata_sample_mismatch_search = ch_metadata_sample_matches_search.mismatched
        ch_sample_qc_pass_matches_search = ch_sample_qc_pass_matches_search.matched
...
workflow filter_samples_with_two_files {
    take:
        ch_all_samples_with_metadata_loaded
        ch_samples_with_metadata_loaded
        ch_qc_passed_samples
...
workflow notifications {
    ...
    main:
        ...
        store_notification_missing_files(
          ...
          ch_metadata_sample_mismatch_search.collect()
        ).subscribe onNext: {
        ...
        store_notification_processed_already(
          ...
          ch_sample_qc_pass_matches_search.collect()
        ).subscribe onNext: {
