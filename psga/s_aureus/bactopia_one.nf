...
OUTPUT_FILES = [
    ...
    JsonOutFile('{output_path}/bactopia_one/local-single-sample/{sample_id}/variants/{genome_assembly_name}/{sample_id}.bam.bai', 'variants/bam-bai'),
    JsonOutFile('{output_path}/bactopia_one/local-single-sample/{sample_id}/variants/{genome_assembly_name}/{sample_id}.consensus.subs.fa.gz', 'variants/consensus-subs'),
    JsonOutFile('{output_path}/bactopia_one/local-single-sample/{sample_id}/variants/{genome_assembly_name}/{sample_id}.consensus.subs.masked.fa.gz', 'variants/consensus.subs.masked'),
